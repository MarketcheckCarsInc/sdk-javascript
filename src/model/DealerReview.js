...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReviewComponents'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReviewComponents'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketcheckCarsApi) {
      root.MarketcheckCarsApi = {};
    }
    root.MarketcheckCarsApi.DealerReview = factory(root.MarketcheckCarsApi.ApiClient, root.MarketcheckCarsApi.ReviewComponents);
  }
}(this, function(ApiClient, ReviewComponents) {
  'use strict';
   ...
   */
  exports.prototype['overall_reviews'] = undefined;
  /**
   * @member {Array.<module:model/ReviewComponents>} review_components
   */
  exports.prototype['review_components'] = undefined;
